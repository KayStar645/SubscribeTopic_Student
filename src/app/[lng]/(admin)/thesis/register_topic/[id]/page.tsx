...
import { InputRange, InputText } from '@resources/components/form';
                ...
                >
                    <div className='flex flex-column gap-3 p-3'>
                        ...
                        <div className='flex align-items-center'>
                            ...
                            <p className='text-900 font-semibold'>{response?.data?.lecturerThesis?.phoneNumber}</p>
                        </div>

                        <div className='flex align-items-center'>
                            <p className='w-15rem'>{t('module:field.teacher.academic')}</p>
                            <p className='text-900 font-semibold'>{response?.data?.lecturerThesis?.academicTitle}</p>
                        </div>
                    </div>
                </Panel>
                ...
                <div className='p-3 bg-white border-round-xl shadow-2'>
                                        ...
                                        onSuccess: () => {
                                            ...
                                            router.push(
                                                language.addPrefixLanguage(
                                                    lng,
                                                    `${ROUTES.thesis.register_topic}?activeItem=register_topic&openMenu=false&parent=thesis`,
                                                ),
                                            );
                                        },
                                    },
                    ...
                    {isFetching ? (
                        ...
                        <p>
                            ...
                            {response?.data?.minQuantity} thành viên và tối đa {response?.data?.maxQuantity} thành viên
                            tham gia thực hiện, được hướng dẫn bởi{' '}
                            {response?.data?.thesisInstructions?.map((t) => t.academicTitle + ' ' + t.name).join(', ')}{' '}
